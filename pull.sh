...
#
# Save logs in /tmp/docker-debug-logs/pull_${timestamp}_${SEMAPHORE_JOB_ID}.txt for internal monitoring.
#
...
cat $LOGS_PATH > /tmp/docker-debug-logs/pull_$(date +"%F_%H-%M-%S")_${SEMAPHORE_JOB_ID}.txt
